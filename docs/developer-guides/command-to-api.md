# 命令行转API开发指南 (v3.32及以下版本 - 已废弃)

> ⚠️ **重要提示**: 此文档适用于 v3.32 及以下版本，已被新的简化架构替代。
> 
> **请查看最新文档**: [Claude API 简化指南](../api/claude-api-simplified.md)
> 
> 从 v3.33 开始，Claude API 使用简化的 `claude -p` 架构，无需复杂的初始化流程。
